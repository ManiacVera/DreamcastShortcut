...
void md5::kos_md5_start(kos_md5_cxt_t* cxt) {
    cxt->size = 0;
...
void md5::kos_md5_hash_block(kos_md5_cxt_t* cxt, const uint8* input, uint32 size) {
    uint32 left, copy;
...
void md5::kos_md5_finish(kos_md5_cxt_t* cxt, uint8 output[16]) {
    uint64 len = cxt->size;
...
void md5::kos_md5(const uint8* input, uint32 size, uint8 output[16]) {
    kos_md5_cxt_t cxt;
